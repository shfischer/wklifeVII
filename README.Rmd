---
title: "length-based empirical data-limited catch rule"
...
The state of the code for the publication is stored in release v1.0 (https://github.com/shfischer/wklifeVII/releases/tag/v1.0).

## Repository structure

The repository contains the following R scripts in the `R/` directory:

* `OM1.R` & `OM2.R`: Scripts for creating the operating models for 29 data-limited fish stocks,
